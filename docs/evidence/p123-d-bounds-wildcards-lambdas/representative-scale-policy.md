...
than an additional PSI contract. Its preserved logs and samples remain under the archive identifiers
`metallurgy-123d-evidence/final-stress-blocker-20260808`,
...
evidence is preserved in archive `metallurgy-123d-evidence/bounded-scale-policy-20260808` with SHA-256 hashes
