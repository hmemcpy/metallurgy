...
private[metallurgy] object NativePsiElementBindings:
  ...
  private def probeInReadAction(project: Project): Either[String, NativePsiElementBindings] =
    val file                                                   = PsiFileFactory
      ...
      .createFileFromText(
        ...
        """package example.syntax
          ...
          |def matchProbe(x: Any): Any = x match
          |  case _ => atomicString
          |  case given String => givenProbe
          |  case namedGiven @ given String => namedGiven
          |  case wildcardBound => wildcardBound
          |  case Nil => "stable"
          |  case 1 | 2 => atomicInteger
          ...
          |val bracedMatch = atomicInteger match { case 1 => atomicString; case _ => atomicInteger }
    ...
    val matches                                                = PsiTreeUtil.findChildrenOfType(file, classOf[ScMatch]).asScala.toVector
    val matchCaseClausesContainers                             = PsiTreeUtil.findChildrenOfType(file, classOf[ScCaseClauses]).asScala.toVector
    val matchCaseClauses                                       = PsiTreeUtil.findChildrenOfType(file, classOf[ScCaseClause]).asScala.toVector
    val matchGuards                                            = PsiTreeUtil.findChildrenOfType(file, classOf[ScGuard]).asScala.toVector
    val matchBlocks                                            = PsiTreeUtil.findChildrenOfType(file, classOf[ScBlock]).asScala.toVector
    val wildcardPatterns                                       = PsiTreeUtil.findChildrenOfType(file, classOf[ScWildcardPattern]).asScala.toVector
    val stableReferencePatterns                                =
      PsiTreeUtil.findChildrenOfType(file, classOf[ScStableReferencePattern]).asScala.toVector
    val literalPatterns                                        = PsiTreeUtil.findChildrenOfType(file, classOf[ScLiteralPattern]).asScala.toVector
    val typedPatterns                                          = PsiTreeUtil.findChildrenOfType(file, classOf[Sc3TypedPattern]).asScala.toVector
    ...
    val constructorPatterns                                    = PsiTreeUtil.findChildrenOfType(file, classOf[ScConstructorPattern]).asScala.toVector
    val compositePatterns                                      = PsiTreeUtil.findChildrenOfType(file, classOf[ScCompositePattern]).asScala.toVector
    val seqWildcardPatterns                                    = PsiTreeUtil.findChildrenOfType(file, classOf[ScSeqWildcardPattern]).asScala.toVector
    ...
    val candidates                                             =
      Vector(
        ...
        matches.lastOption.orNull,
        matchCaseClausesContainers.headOption.orNull,
        matchCaseClauses.headOption.orNull,
        matchGuards.headOption.orNull,
        matchBlocks.headOption.orNull,
        wildcardPatterns.headOption.orNull,
        stableReferencePatterns.headOption.orNull,
        literalPatterns.headOption.orNull,
        typedPatterns.headOption.orNull,
        typePatterns.headOption.orNull,
        ...
        compositePatterns.headOption.orNull,
        seqWildcardPatterns.headOption.orNull
        ...
        Right(
          NativePsiElementBindings(
            ...
            Map(
              ...
              PsiOutputRoleId.MatchExpression        -> matches.head.getNode.getElementType,
              PsiOutputRoleId.CaseClauses            -> matchCaseClausesContainers.head.getNode.getElementType,
              PsiOutputRoleId.CaseClause             -> matchCaseClauses.head.getNode.getElementType,
              PsiOutputRoleId.Guard                  -> matchGuards.head.getNode.getElementType,
              PsiOutputRoleId.Block                  -> matchBlocks.head.getNode.getElementType,
              PsiOutputRoleId.PatternWildcard        -> wildcardPatterns.head.getNode.getElementType,
              PsiOutputRoleId.StableReferencePattern -> stableReferencePatterns.head.getNode.getElementType,
              PsiOutputRoleId.LiteralPattern         -> literalPatterns.head.getNode.getElementType,
              PsiOutputRoleId.TypedPattern           -> typedPatterns.head.getNode.getElementType,
              ...
              PsiOutputRoleId.ConstructorPattern     -> constructorPatterns.head.getNode.getElementType,
              PsiOutputRoleId.CompositePattern       -> compositePatterns.head.getNode.getElementType,
              PsiOutputRoleId.SeqWildcardPattern     -> seqWildcardPatterns.head.getNode.getElementType,
            ...
            Map(
              ...
              PsiOutputRoleId.MatchExpression        -> surfaceId(matches.head.getClass),
              PsiOutputRoleId.CaseClauses            -> surfaceId(matchCaseClausesContainers.head.getClass),
              PsiOutputRoleId.CaseClause             -> surfaceId(matchCaseClauses.head.getClass),
              PsiOutputRoleId.Guard                  -> surfaceId(matchGuards.head.getClass),
              PsiOutputRoleId.Block                  -> surfaceId(matchBlocks.head.getClass),
              PsiOutputRoleId.PatternWildcard        -> surfaceId(wildcardPatterns.head.getClass),
              PsiOutputRoleId.LiteralPattern         -> surfaceId(literalPatterns.head.getClass),
              PsiOutputRoleId.StableReferencePattern -> surfaceId(stableReferencePatterns.head.getClass),
              PsiOutputRoleId.TypedPattern           -> surfaceId(typedPatterns.head.getClass),
              ...
              PsiOutputRoleId.PatternArgumentList    -> surfaceId(patternArgumentLists.head.getClass),
              PsiOutputRoleId.ConstructorPattern     -> surfaceId(constructorPatterns.head.getClass),
              PsiOutputRoleId.CompositePattern       -> surfaceId(compositePatterns.head.getClass),
