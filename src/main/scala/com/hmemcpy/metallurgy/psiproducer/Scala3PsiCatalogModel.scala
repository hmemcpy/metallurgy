...
private[metallurgy] object GrammarRoleId:
  ...
  val MatchExpression           = GrammarRoleId("scala.expression.match")
  val CaseClause                = GrammarRoleId("scala.expression.match.case")
  val PatternWildcard           = GrammarRoleId("scala.pattern.wildcard")
  val PatternStableIdentifier   = GrammarRoleId("scala.pattern.stable-identifier")
...
private[metallurgy] object PsiOutputRoleId:
  ...
  val MatchExpression        = PsiOutputRoleId("scala.expression.match")
  val CaseClauses            = PsiOutputRoleId("scala.expression.match.cases")
  val CaseClause             = PsiOutputRoleId("scala.expression.match.case")
  val Guard                  = PsiOutputRoleId("scala.expression.match.guard")
  val Block                  = PsiOutputRoleId("scala.expression.block")
  val PatternWildcard        = PsiOutputRoleId("scala.pattern.wildcard")
  val StableReferencePattern = PsiOutputRoleId("scala.pattern.stable-reference")
  val LiteralPattern         = PsiOutputRoleId("scala.pattern.literal")
  ...
  val CompositePattern       = PsiOutputRoleId("scala.pattern.composite")
  val SeqWildcardPattern     = PsiOutputRoleId("scala.pattern.seq-wildcard")
...
private[metallurgy] object StableRoleInventory:
  ...
  val Reviewed = StableRoleInventory(
    Set(
      ...
      GrammarRoleId.MatchExpression,
      GrammarRoleId.CaseClause,
      GrammarRoleId.PatternWildcard,
      GrammarRoleId.PatternLiteral,
...
private[metallurgy] object DefinitionPersistenceSurfaces:
  ...
  val ExternalIds            = Map(
    ...
    PsiOutputRoleId.NamingPattern        -> "scala.naming pattern",
    PsiOutputRoleId.SeqWildcardPattern   -> "scala.seq wildcard pattern",
