...
/** Verbatim port of the bundled Scala plugin's `Scala3OpaqueTypeAliasIntegrationTest`. Snippets are kept exactly; only
  * the asserting helpers differ.
  */
final class Scala3OpaqueTypeAliasIntegrationCompatTest extends Scala3CompatTestCase:

  def testExtensionsOnOpaqueTypeAndAliases(): Unit = checkTextHasNoErrors(
    s"""
       |object Scope {
       |  class MyClass
  ...
  def testOpaqueTypeCompanionExtensionIndented(): Unit = checkTextHasNoErrors(
    s"""
       |object Scope:
       |  class MyClass
       |  object MyClass:
  ...
  def testOpaqueAliasOfNothingWithCompanionExtension(): Unit = checkTextHasNoErrors(
    s"""
       |object Opaque:
       |  object Scope:
  ...
  def testOverloadedIArrayParameterMethods(): Unit = checkTextHasNoErrors(
    s"""
       |class A {
  ...
  def testOpaqueTypeWithTypeBoundAndCaseClassCopy(): Unit = checkTextHasNoErrors(
    s"""
       |object MainX {
       |  trait Base
  ...
  def testOpaqueTypeWithArithmeticExtensionOperators(): Unit = checkTextHasNoErrors(
    s"""
       |object Native {
  ...
  def testOpaqueTypeHidesUnderlyingMethodError(): Unit = checkHasErrorAroundCaret(
    s"""
       |object Native {
  ...
  def testOpaqueTypeExtensionShadowsUnderlyingMethod(): Unit = checkTextHasNoErrors(
    s"""
       |object Native {
       |  type CoordT = Double
  ...
  def testOpaqueTypeWithChainedExtensionMethods(): Unit = checkTextHasNoErrors(
    s"""
       |object Native {
       |  class V(val x: Double, val y: Double) {
       |    def cross(v: V): V = ???
  ...
  // The bundled plugin fails to resolve the `*` operator here; the snippet is kept verbatim.
  def testOpaqueTypeWithGivenTypeclassOperator(): Unit = checkTextHasNoErrors(
    s"""
       |object Native {
  ...
  def testOpaqueTypeWithTypeclassContextBound(): Unit = checkTextHasNoErrors(
    s"""
       |object Native {
       |  case class V(x: Double, y: Double)
       |  trait Vectoric[V]
  ...
  def testOpaqueTypeWithTypeBoundsAndExtensionDelegation(): Unit = checkTextHasNoErrors(
    s"""
       |object Types {
       |  class O {
  ...
  def testOpaqueTypeWithTypeclassOpsTraitExtension(): Unit = checkTextHasNoErrors(
    s"""
       |object Native {
       |  case class Vec3(x: Double, y: Double, z: Double)
       |}
  ...
  def testOpaqueTypeWithGivenTypeclassInstanceInScope(): Unit = checkTextHasNoErrors(
    s"""
       |trait Bar[A]
       |object A {
       |  opaque type Foo = Any
  ...
  def testOpaqueTypeStubBoundedByParameterizedTrait(): Unit = checkTextHasNoErrors(
    s"""
       |trait MyService {
  ...
  def testOpaqueTypeExtensionResolvedInPatternMatch(): Unit = checkTextHasNoErrors(
    s"""
       |object Native {
       |  case class Vec3(x: Double, y: Double, z: Double)
       |}
  ...
  def testOpaqueTypeWithOperatorExtensionViaTypeclass(): Unit = checkTextHasNoErrors(
    s"""
       |object Native {
       |  case class Vec3(x: Double, y: Double, z: Double) {
  ...
  def testOpaqueTypeWithUpperTypeBoundConformance(): Unit = checkTextHasNoErrors(
    s"""
       |object Wrapper {
  ...
  def testOpaqueTypeExtensionsFromNestedAndTopLevelScope(): Unit = checkTextHasNoErrors(
    s"""
       |object MyObject:
