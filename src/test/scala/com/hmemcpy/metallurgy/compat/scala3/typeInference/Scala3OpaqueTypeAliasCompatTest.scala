...
/** Verbatim port of the bundled Scala plugin's `Scala3OpaqueTypeAliasTest`. Snippets are kept exactly; only the
  * asserting base class differs.
  */
final class Scala3OpaqueTypeAliasCompatTest extends Scala3CompatTestCase:
  ...
  def testOpaqueAliasOfNothingExtensionAccessedOutside(): Unit = {
    checkTextHasNoErrors(
      s"""
         |object Inside:
  ...
  def testOpaqueTypeWithVarianceBoundAndCaseClassCopy(): Unit = {
    checkTextHasNoErrors(
      s"""
         |trait Base
  ...
  def testOuterFile(): Unit = checkTextHasNoErrors(s"""
       |opaque type T = Int
       |val v: T = 123""".stripMargin)

  def testOuterPackage(): Unit = checkTextHasNoErrors(s"""
       |package outer
       |
       |opaque type T = Int
       |val v: T = 123""".stripMargin)

  def testOuterObject(): Unit = checkTextHasNoErrors(s"""
       |object Outer:
       |  opaque type T = Int
       |  val v: T = 123""".stripMargin)

  def testOuterFileInnerObject(): Unit = checkHasErrorAroundCaret(s"""
       |opaque type T = Int
       |object Inner:
       |  val v: T = ${CARET}123""".stripMargin)

  def testOuterPackageInnerObject(): Unit = checkHasErrorAroundCaret(s"""
       |package outer
       |
       |opaque type T = Int
       |object Inner:
  ...
  def testOuterObjectInnerObject(): Unit = checkTextHasNoErrors(s"""
       |object Outer:
       |  opaque type T = Int
       |  object Inner:
       |    val v: T = 123""".stripMargin)

  def testOuterObjectsInnerObject(): Unit = checkTextHasNoErrors(s"""
       |object Outer1:
       |  object Outer2:
       |    opaque type T = Int
       |    object Inner:
  ...
  def testOuterObjectInnerObjects(): Unit = checkTextHasNoErrors(s"""
       |object Outer:
       |  opaque type T = Int
       |  object Inner1:
       |    object Inner2:
  ...
  def testOuterPackageAndObjectInnerObject(): Unit = checkTextHasNoErrors(s"""
       |package outer
       |
       |object Outer:
       |  opaque type T = Int
  ...
  def testOuterFileInnerCompanionObject(): Unit = checkTextHasNoErrors(s"""
       |opaque type T = Int
       |object T:
       |  val v: T = 123""".stripMargin)

  def testOuterFileInnerCompanionObjectInnerObject(): Unit = checkTextHasNoErrors(s"""
       |opaque type T = Int
       |object T:
       |  object Inner:
       |    val v: T = 123""".stripMargin)

  def testOpaqueTypeCompanionTypeAliasMember(): Unit = checkTextHasNoErrors(
    """
      |object Types {
      |  trait B
      |  class C extends B
  ...
  def testOpaqueTypeWithGivenTypeclassInstance(): Unit = checkTextHasNoErrors(
    """
      |opaque type A = Int
      |
      |trait B[C] {
