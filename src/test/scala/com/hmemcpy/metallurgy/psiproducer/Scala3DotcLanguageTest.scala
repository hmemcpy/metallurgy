...
/** The Metallurgy Scala 3 dialect is a kind of Scala 3 and Scala, carries the marker interfaces Scala3Language
  * requires, and parses a Scala source into source-compatible Scala PSI.
  */
