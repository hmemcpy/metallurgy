...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("8e7bec10865e5315544d07e5f81d502197d6c51771f192c7ba377c9474a48feb", catalog.fingerprint)
    assertEquals("9cdf8aa1906122628d64c5a672dcc3eb078374fbef3dfc35f44f76a68b75ae6c", persistence.fingerprint)
    assertTrue(
