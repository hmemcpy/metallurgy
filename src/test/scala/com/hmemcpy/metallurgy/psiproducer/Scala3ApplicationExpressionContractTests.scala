...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("63f7d32879efbc5d719c15f03bd43e490c065f35a03fa7ed0191007f4cfcea14", catalog.fingerprint)
    assertEquals("b46b182d8addb6cb089a94e17cefbf2cf0656ece6a7fa87b22b133e8e8dec99f", persistence.fingerprint)
    assertTrue(
