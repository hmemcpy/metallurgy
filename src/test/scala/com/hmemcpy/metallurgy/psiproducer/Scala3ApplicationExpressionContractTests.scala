...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("5fb9cfcfa90a4970c57312348b440e45634ead4dde7c544f2ea1f52869aa7467", catalog.fingerprint)
    assertEquals("b7aa86fd293c9b9523967604ccfd608e45a069a55aceb9c3edf83a6dfd16f3cd", persistence.fingerprint)
    assertTrue(
