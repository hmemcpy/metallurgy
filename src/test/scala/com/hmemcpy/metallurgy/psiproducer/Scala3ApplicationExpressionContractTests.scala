...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("aaa42dfb828e9c867c171373bab3873e824521b52e5825101b44143f5666875b", catalog.fingerprint)
    assertEquals("49a9fcda1b8fe23aff4e929e48bc79c839250804d0eec7c3a5576f884fccba19", persistence.fingerprint)
    assertTrue(
