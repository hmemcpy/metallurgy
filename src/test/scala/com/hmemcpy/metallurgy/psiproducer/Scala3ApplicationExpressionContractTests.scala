...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("4b720de648ad0bd18659e7221a689afe9c6776c9f153a4be78d4eecfb14e0c6b", catalog.fingerprint)
    assertEquals("871e587be19a8bfa8d68a03458d50253f4bdf922faa6f78476827127b27b2e3a", persistence.fingerprint)
    assertTrue(
