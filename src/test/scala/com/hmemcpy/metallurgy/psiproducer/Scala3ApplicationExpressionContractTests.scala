...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("7b533bb1bc1cffff7e20665ac50a2a956b8c60be36cb2c97b9429448205073d0", catalog.fingerprint)
    assertEquals("5cd7483d0d73563e0f32069a04ac406e512b3776ee08553ba4bf4b979b1fde32", persistence.fingerprint)
    assertTrue(
