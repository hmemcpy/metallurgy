...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("de3800acb7ddf036e2f1e87e98f4605c8d9b3a65fd62f8e098b2e22d4392b5dd", catalog.fingerprint)
    assertEquals("213c0ec72ada59165b6fc07470b14b8a8b6b4a7e59395b5c3ab1ef6b1ef0b8be", persistence.fingerprint)
    assertTrue(
