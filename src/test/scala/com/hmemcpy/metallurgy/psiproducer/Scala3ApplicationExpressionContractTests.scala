...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("869eb2972aac8f6c76f76aaedfa028b6d588d00a43ca01929d94f6feff47d0da", catalog.fingerprint)
    assertEquals("c688331774df2b35d921eb330639c39987f976462376a7f8254a0b3c1d09f4ab", persistence.fingerprint)
    assertTrue(
