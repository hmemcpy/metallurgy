...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("bdc7873bb3f71f5c88a6ae0453db6b89296c748625bd7216232a475a5712b513", catalog.fingerprint)
    assertEquals("3929da9b84cad934713513498d68df42153f3ee8b0de9ec7fa66b213f751f04f", persistence.fingerprint)
    assertTrue(
