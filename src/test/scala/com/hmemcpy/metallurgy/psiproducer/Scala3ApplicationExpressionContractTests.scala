...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("f15773391a9d357a74ffd3c1d676ae877f0be7ac337f8fb16cc24858bf5137d4", catalog.fingerprint)
    assertEquals("2f23b108abf74ea05bdf3de86b97dace63c2c72c74589f3921c21a7054c69112", persistence.fingerprint)
    assertTrue(
