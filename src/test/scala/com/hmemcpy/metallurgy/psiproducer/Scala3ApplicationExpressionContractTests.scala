...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("6c7502758e4fc2c19f42027fe55041fbaeb587d7ec1c87abbf36717672e8a5e3", catalog.fingerprint)
    assertEquals("4a61530347cedc76839b9398243af7c19803a8952a3d38de2968b2a1c65169ba", persistence.fingerprint)
    assertTrue(
