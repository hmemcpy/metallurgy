...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("0da93185d2483cee04c82251b668011676f4c48de1ce49cff4bafe912124970d", catalog.fingerprint)
    assertEquals("65a5a620a9b3a3b5088a2ccb9cedeaef33dd8b48efb4af9555cea14743935417", persistence.fingerprint)
    assertTrue(
