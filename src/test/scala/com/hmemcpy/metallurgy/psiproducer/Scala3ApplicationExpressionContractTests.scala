...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("44529de22e9b0107f5af5459e83a18cc72f6946077c8f5583c58ecf66b4a1e50", catalog.fingerprint)
    assertEquals("95041533f2b134954b299076b35b97be15ec3c8a07174004a0cc23f0ac462053", persistence.fingerprint)
    assertTrue(
