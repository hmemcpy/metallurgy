...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("9d6b3d8297872d69789a310c11162b1a163cc69004927faa2933b27d8943b172", catalog.fingerprint)
    assertEquals("ac2e67bbee932cbee07daf4e50dd5f4c5f818f832ea3669be19fb2bc68f3c866", persistence.fingerprint)
    assertTrue(
