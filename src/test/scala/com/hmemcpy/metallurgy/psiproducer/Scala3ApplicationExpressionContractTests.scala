...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("e93c90b547649380c8acdd909ad28683d0d2766a490311162571781b39109f96", catalog.fingerprint)
    assertEquals("903f8bb2f85bab49b73220a82f058494655842996440315b10814ef5a5022b95", persistence.fingerprint)
    assertTrue(
