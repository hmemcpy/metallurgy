...
private[psiproducer] trait Scala3ApplicationExpressionContractTests extends Scala3PsiProductionCatalogTestSupport:
  ...
  @Test def reviewedRuntimeCatalogOwnsOrdinaryApplicationsWithoutChangingPersistence(): Unit =
    ...
    assertEquals("3e20123afb91dfc64be7b2f25b7cc929e67093d8d47d45152b511f2f4e457596", catalog.fingerprint)
    assertEquals("c14af31a5208fc230bc4bce30cd394a2dddab331af06db9682b8436469b55657", persistence.fingerprint)
    assertTrue(
